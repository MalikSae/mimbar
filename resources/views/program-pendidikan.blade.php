...
@section('title', 'Program Pendidikan - Yayasan Mimbar Al-Tauhid')
...
<main class="min-h-[60vh] flex items-center justify-center bg-gray-50">
    <div class="text-center px-4">
        ...
        <h1 class="text-3xl md:text-4xl font-heading font-bold text-gray-900 mb-4">Program Pendidikan</h1>
