...
@section('title', 'Program Sosial - Yayasan Mimbar Al-Tauhid')
...
<main class="min-h-[60vh] flex items-center justify-center bg-gray-50">
    <div class="text-center px-4">
        <div class="inline-flex items-center justify-center w-16 h-16 rounded-full bg-primary-light text-primary mb-6">
            <iconify-icon icon="lucide:heart-handshake" width="32"></iconify-icon>
        </div>
        <h1 class="text-3xl md:text-4xl font-heading font-bold text-gray-900 mb-4">Program Sosial</h1>
